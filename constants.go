...
const NATURAL_KILLER_DAMAGE_KILL_THRESHOLD = MAX_DAMAGE * 0.75
...
const MAX_VIRUS_CONCENTRATION = int64((1 * time.Minute) / CELL_CLOCK_RATE)
...
const HORMONE_MACROPHAGE_DROP = 10
