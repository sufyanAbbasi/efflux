...
const LEUKOCYTE_INFLAMMATION_THRESHOLD = 100
...
const HORMONE_M_CSF_THRESHOLD = 10 // Produce Monocyte --> Macrophage, Dendritic
const HORMONE_IL3_THRESHOLD = 10   // Produce Lymphoblast --> Natural Killer
