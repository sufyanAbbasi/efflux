...
systems that keep you alive. So instead, we'll sprinkle a bit more abstraction
magic.

Each organ of the human body performs a service that another organ requires for
its normal use.